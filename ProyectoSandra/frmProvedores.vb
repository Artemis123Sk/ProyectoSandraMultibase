...
Public Class frmProvedores
    ...
    Private Sub frmProvedores_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        comando.CommandText = "Select * from provedores"
    ...
    Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        filas -= 1
        colocar(filas)
        comando.CommandText = "SELECT count(idProvedor) FROM provedores"
        lector = comando.ExecuteReader
        lector.Read()
        txtIdProvedor.Text = CInt(lector(0)) + 1
        lector.Close()
        activar()
    End Sub
    ...
    Private Sub btnGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
        Try
            If opcion = 2 Then
                comando.CommandText = "UPDATE provedores set nombre = '" & txtNombre.Text & "', celular = '" & txtCelular.Text & "', telefono = '" & txtTelefono.Text & "' Where idProvedor =" & txtIdProvedor.Text
            ElseIf opcion = 1 Then
                comando.CommandText = "insert into provedores(idProvedor,nombre,celular,telefono) values(" & txtIdProvedor.Text & ",'" & txtNombre.Text & "','" & txtCelular.Text & "','" & txtTelefono.Text & "')"
            End If
    ...
    Private Sub colocar(fila As Integer)
        ...
        txtIdProvedor.Text = DataGridView1.Item(0, fila).Value
        txtNombre.Text = DataGridView1.Item(1, fila).Value
        txtCelular.Text = DataGridView1.Item(2, fila).Value
        txtTelefono.Text = DataGridView1.Item(3, fila).Value
    End Sub
